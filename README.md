...
```bash
python unlock.py --use-mediapipe --log unlocks.log --exit-on-unlock
```
...
```bash
python unlock.py --use-mediapipe --ear 0.18 --consec 3 --blinks 2 --log unlocks.log
```
...
Repository: https://github.com/jackyphuti/Face-Eye-blink-unlock-demo
